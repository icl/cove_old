...
VideoJS.player.extend({
  ...
  buildAndActivateControlBar: function(){
      ...
      <div class="vjs-controls">
        ...
        <div class="vjs-progress-control">
          <div class="vjs-progress-holder">
            ...
            <div class="cove-snippet-selection"></div>
          </div>
        </div>
    ...
    */
    ...
    // COVE. Create the snippet selection display
    this.snippetSelectionBar = _V_.createElement("div", { className: "cove-snippet-selection" });
    this.progressHolder.appendChild(this.snippetSelectionBar);
    this.activateElement(this.snippetSelectionBar, "snippetSelectionBar");    
  ...
  markSnippetEnd: function() {
    this.snippetEnd(this.currentTime());
  },
...
/* COVE. Snippet Selection Bar Behaviors
================================================================================ */
VideoJS.player.newBehavior("snippetSelectionBar", function(element){
    if (!this.snippetSelectionBars) {
      this.snippetSelectionBars = [];
      this.onCurrentTimeUpdate(this.updateSnippetSelectionBars);
    }
    this.snippetSelectionBars.push(element);
  },{
    updateSnippetSelectionBars: function(newTime){
      ...
      this.each(this.snippetSelectionBars, function(bar){
        if (bar.style) {
          bar.style.left = _V_.round(left * 100, 2) + "%";
          bar.style.right = _V_.round(right * 100, 2) + "%";
